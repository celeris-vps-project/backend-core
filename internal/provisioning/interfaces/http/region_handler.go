...
// RegionHandler uses ProvisioningAppService (region CRUD was merged into it).
type RegionHandler struct{ svc *app.ProvisioningAppService }

func NewRegionHandler(svc *app.ProvisioningAppService) *RegionHandler {
